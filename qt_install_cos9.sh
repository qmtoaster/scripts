...
dnf -y install logwatch bind bind-utils telnet yum-utils chrony acpid at autofs bzip2 \
               smartmontools wget vsftpd mod_ssl fail2ban roundcubemail php-mysqlnd
